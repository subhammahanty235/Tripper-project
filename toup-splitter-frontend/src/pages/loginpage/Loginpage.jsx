...
//    states to store user's inputs
    ...
    const loginToExistingTrip_func =async (e)=>{
        ...
        console.log(logintoexistingTrip)
        const response_data = await response.json();
        // clear the form
        ...
        if(response_data.flag===true){
            ...
            const res =await fetch(`${ApiLink}/sendmail`, {
                ...
                body: JSON.stringify({ email:logintonewTrip.emailId , text: `dear ${logintonewTrip.name} , you have successfully logged in to your trip ` })
